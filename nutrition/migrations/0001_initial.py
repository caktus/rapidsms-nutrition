...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'nutrition_report', (
            ...
            ('data_date', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
    ...
    models = {
        u'nutrition.report': {
            ...
            'data_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
